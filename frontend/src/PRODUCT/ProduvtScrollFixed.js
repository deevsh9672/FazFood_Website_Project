        ...
        < >
         <Navbar2/>
                ...
                <Row>
                    ...
                    <Col xs={12} md={6}>
                        <h1 style={{ fontWeight: 'bold' }}>SAUSAGE, EGG & CHEESE <br/> CROISSAN’WICH</h1>
                        ...
                        <h4 style={{ fontWeight: 'bold', color: 'red' }}>$5.60</h4>
